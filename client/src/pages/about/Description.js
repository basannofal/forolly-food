...
const Description = () => {
  return (
    <>
      <div className="container lg:my-12 mx-auto w-11/12 mb-8" id="about-description">
        <div className="md:flex block mt-5">
          <div className="pt-4 pb-6 ps-3 bg-white">
            <p className="text-3xl font-bold tracking-wide mb-5">ABOUT US</p>
            <p className="tracking-wide leading-7 md:w-4/5 w-11/12">
              ...
              adolescence and the life-changing taste of its items, with which
              we will dependably associate with. The group of
              <strong>‘Forolly’ </strong>wishes you upbeat biting!
            </p>
          </div>
          <div className="pt-4 pb-6 ps-3">
            <p className="text-3xl font-bold tracking-wide mb-5">
              🙂WE ARE THE BEST
            </p>
            <p className="tracking-wide leading-7 md:w-4/5 w-11/12">
              ...
              the life-changing taste of its items, with which we will
              dependably associate with. The group of ‘Forolly’ wishes you
              upbeat biting!
            </p>
          </div>
        </div>
        ...
        <div className="md:p-5 px-3 pb-2">
          <div>
            <p>
              ...
              to satisfy the chocoholics.‘Forolly’ guarantees to leave a
