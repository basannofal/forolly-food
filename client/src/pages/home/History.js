    ...
    <>
      <div className="container">
        <div className="flex">
          ...
          <div className="lg:w-3/6 sm:w-full lg:px-12 md:px-20 pt-12 sm:px-12 ps-8 bg-no-repeat bg-right-top left-history_peregraph">
            <p className="text-red-700 mb-6 font-handwriting text-19">
              About us
            </p>
            ...
            <p className="font-normal text-14 leading-loose">
